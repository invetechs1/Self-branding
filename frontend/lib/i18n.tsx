...
const dict = {
  en: {
    ...
    drafts: {
      ...
      rejectedArchiveNote: "Rejected drafts are kept here, never deleted.",
      rejectedOn: "Rejected {when}", rejectedByRegenerate: "Superseded by a regenerated draft",
      noReasonGiven: "No reason given.", noRejected: "Nothing rejected yet.",
  ...
  ar: {
    ...
    drafts: {
      ...
      rejectedArchiveNote: "المسودات المرفوضة تُحفظ هنا، لا تُحذف أبدًا.",
      rejectedOn: "رُفضت {when}", rejectedByRegenerate: "استُبدلت بمسودة معاد توليدها",
      noReasonGiven: "لا يوجد سبب مذكور.", noRejected: "لا يوجد شيء مرفوض بعد.",
